        ...
        {showConfirm && (
          <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
            ...
            <div className="relative w-full max-w-sm bg-[#FEFCF7] dark:bg-zinc-900 rounded-3xl shadow-2xl border border-[#E8E0D0] dark:border-zinc-700 p-6 overflow-hidden">
              ...
              {uploading && (
                <UploadProgress phase={uploadPhase} uploadPercent={uploadPercent} savingLabel="수정 저장 중..." />
              )}
              <div className="flex gap-2">
                <button
                  onClick={() => setShowConfirm(false)}
                  disabled={uploading}
                  className="flex flex-1 items-center justify-center rounded-xl border border-[#E8E0D0] dark:border-zinc-700 bg-[#FEFCF7] dark:bg-zinc-800 py-3 text-[13px] font-semibold text-[#6B5D47] dark:text-zinc-300 hover:bg-[#F5F0E5] dark:hover:bg-zinc-700 disabled:opacity-50 active:scale-95 transition-all"
                >
                  취소
                </button>
                <button
