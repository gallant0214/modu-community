...
// 직종코드: 스포츠·레크레이션 전체 + 하위 코드
const OCCUPATION_CODES = ["622000", "622100", "622200", "622201", "622202", "622300", "622301", "622302"];
// 추가 키워드 검색 (직종코드에 걸리지 않는 스포츠 관련 채용 보완)
const EXTRA_KEYWORDS = ["스포츠", "체육관", "피트니스", "헬스장", "수영장", "골프장", "태권도장"];
