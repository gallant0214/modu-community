...
const SPORTS_WORDS = /태권도|(?<![가-힣])유도|검도|복싱|권투|합기도|주짓수|킥복싱|무에타이|무술|헬스(?!케어)|피트니스|트레이너|크로스핏|필라테스|요가|발레|에어로빅|무용|줄넘기|수영(?![구동로시군면읍리만역])|골프|테니스|배드민턴|탁구|축구|풋살|농구|배구|야구|클라이밍|암벽|볼더링|승마|체조|댄스|양궁|펜싱|사격|스키(?![드니마핑터])|스노보드|스케이트|볼링|스쿼시|스포츠|체육|운동|스포츠지도사|체육지도사|체육교사|스포츠강사|체육강사|운동강사|헬스강사|수영강사|골프강사|테니스강사|요가강사|필라테스강사|태권도강사|유도강사|검도강사|레슨|인스트럭터|레저|생활체육|체력단련|PT|GYM|짐|웰니스|피지컬|유아체육|유소년|어린이체육|장애인체육|장애인스포츠|노인체육|노인스포츠|실버체육|호텔피트니스|호텔스파|운동처방|국민체육|체육회|체육진흥|종합운동장|문화체육/i;
