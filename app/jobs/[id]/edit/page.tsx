    ...
    async function load() {
      try {
        ...
        setForm({
          ...
          author_role: data.author_role || AUTHOR_ROLES[0],
          author_name: data.author_name || "",
          contact_type: data.contact_type || CONTACT_TYPES[0],
          contact: data.contact || "",
          sport: data.sport || "",
          region_name: data.region_name || "",
          region_code: data.region_code || "",
          employment_type: data.employment_type || EMPLOYMENT_TYPES[0],
          salary: data.salary || "",
  ...
  if (notFound) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-2 px-4">
        <p className="text-zinc-500 text-sm">게시글을 찾을 수 없습니다.</p>
    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="flex items-center gap-2 px-3 py-2.5 border-b border-zinc-100 dark:border-zinc-800">
          ...
          <span className="text-sm font-semibold text-zinc-900 dark:text-zinc-100 flex-1">구인 글 수정</span>
          <button
        ...
        <div className="px-4 py-4 space-y-4">
          ...
          >{submitting ? "수정 중..." : "구인 글 수정"}</button>
        </div>
      </div>
