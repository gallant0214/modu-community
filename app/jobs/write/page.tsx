      ...
      <div className="flex flex-col items-center justify-center min-h-[80vh] px-4">
        <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-2xl shadow-lg border border-zinc-100 dark:border-zinc-800 p-8 sm:p-10 text-center">
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-6 leading-relaxed">
            로그인하면 구인 공고 등록, 관리, 지원자 확인 등<br />
            채용 관련 기능을 바로 이용할 수 있어요
          </p>
          {/* Google 로그인 */}
          <button onClick={signInWithGoogle} className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-600 rounded-xl text-sm font-semibold text-zinc-700 dark:text-zinc-200 shadow-sm hover:bg-zinc-50 dark:hover:bg-zinc-700 hover:shadow-md transition-all">
        ...
        <div className="mt-6 flex items-center gap-4 text-xs text-zinc-400 dark:text-zinc-500">
          <a href="/jobs" className="hover:text-zinc-600 dark:hover:text-zinc-300 transition-colors">공고 둘러보기</a>
          <span>·</span>
          <a href="/" className="hover:text-zinc-600 dark:hover:text-zinc-300 transition-colors">홈으로 돌아가기</a>
        </div>
      </div>
    </div>
  );
