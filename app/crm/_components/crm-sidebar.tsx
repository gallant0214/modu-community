...
export function CrmSidebar({ role, centerName, isSoloOwner: _isSoloOwner }: Props) {
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex flex-col w-60 shrink-0 border-r border-[#E8E0D0] dark:border-zinc-800 bg-[#FBF7EB]/40 dark:bg-zinc-900/40 sticky top-14 self-start h-[calc(100dvh-3.5rem)] pt-2 md:pt-3">
