...
function check2_CategoryMatch() {
  const BB_KEYWORDS = [
    ...
    "알파세포","베타세포","Epley","Brzycki","구술",
    "트랜스지방","불포화지방","포화지방","GLUT4","글루트","카르노신","베타알라닌","히스티딘",
    "슈퍼","컴파운드","자이언트","모멘트","Moment Arm","B6","B12","피리독신","시아노코발라민",
    "카나비노이드","글루코코르티코이드","마약","코어","사이드밴드","사이드플랭크","백익스텐션","버드독",
    "요방형근","척추기립근","호흡 보조근","사각근","소흉근","횡격막",
  ];
  for (const p of newPosts) {
    if (p.categoryId !== 1) {
...
async function main() {
  console.log(`\n=== 46차 시드 ${DRY_RUN ? "[DRY RUN]" : "[PROD INSERT]"} ===\n`);
