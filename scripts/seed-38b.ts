/**
 * 38차 보충 시드 prod insert 스크립트
 *
 * 실행: cd modu-community && npx -y tsx scripts/seed-38b.ts [--dry-run]
 */
...
function runAllChecks() {
  console.log("=== 38차 보충 시드 6-check 검증 ===");
...
async function main() {
  ...
  console.log(
    "\n👉 다음 단계: cacheOnly POST로 홈 캐시 무효화 호출"
  );
}
