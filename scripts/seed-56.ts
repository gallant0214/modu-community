...
import { newPosts, pickRegion, PREV_AUTHOR_POOLS, AUTHOR_POOL, MIXED_POOL } from "../app/api/admin/seed-community-reviews-56/data";
...
async function main() {
  console.log(`\n=== 56차 시드 ${DRY_RUN ? "[DRY RUN]" : "[PROD INSERT]"} ===\n`);
