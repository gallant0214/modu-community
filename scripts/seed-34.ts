/**
 * 34차 시드 prod insert 스크립트
 *
 * 실행: cd modu-community && npx -y tsx scripts/seed-34.ts [--dry-run]
 *
...
function check2_CategoryMatch(posts: SeedPost[]) {
  const SPORT_KEYWORDS: Record<number, string[]> = {
    1: ["보디빌딩", "헬스", "웨이트", "포징", "쿼터턴", "스플릿스쿼트", "런지", "딥스", "치닝디핑", "구술", "실기"],
    5: ["수영", "IM", "글라이딩", "발차기"],
    20: ["파크골프"],
    6: ["골프"],
  };
